...
class Api
{
    ...
    {
        return Helper::retry(function () use ($ownerId, $photo, $message) {
    ...
    {
        return Helper::retry(function () use ($ownerId, $image) {
            return $this->singleUpload( $ownerId, [
                'media_type' => 'STORIES',
                'image_url'  => $image['url']
            ]);
    ...
    {
        return Helper::retry(function () use ($ownerId, $video) {
            return $this->singleUpload( $ownerId, [
                'media_type' => 'STORIES',
                'video_url'  => $video['url']
            ]);
    ...
    {
        return Helper::retry(function () use ( $ownerId, $video, $message ) {
            return $this->singleUpload( $ownerId, [
                'media_type' => 'REELS',
                'video_url'  => $video['url'],
                'caption'    => $message,
