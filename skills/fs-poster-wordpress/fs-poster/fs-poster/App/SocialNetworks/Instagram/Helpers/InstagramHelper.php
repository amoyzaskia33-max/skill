...
class InstagramHelper
{
	...
	const MIN_WIDTH_PHOTO = 320;
	const MAX_WIDTH_PHOTO = 1440;
    ...
    public static function imageForFeed ( $photo ) : array
    {
        ...
        if ( $newWidth > self::MAX_WIDTH_PHOTO ) {
            $newHeight = (int)((self::MAX_WIDTH_PHOTO / $newWidth) * $newHeight);
            $newWidth  = self::MAX_WIDTH_PHOTO;
        }
        else if ( $newWidth < self::MIN_WIDTH_PHOTO ) {
            $newHeight = (int)(( self::MIN_WIDTH_PHOTO / $newWidth ) * $newHeight);
            $newWidth  = self::MIN_WIDTH_PHOTO;
        }
